...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, jpegThumbnail: global.thumb, surface: 200, message: '©Created By Fajar Alfarizi', orderTitle: 'Felix-MD', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		...
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title": global.fake, "h": `Created By Fajar Alfarizi`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': global.fake, 'jpegThumbnail': global.thumb}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "https://chat.whatsapp.com/BTAHKRz8qSeGiMnym1Xc38","groupName": "Fajar Alfarizi", "caption": global.fake, 'jpegThumbnail': global.thumb}}}
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title": global.fake, "h": `Created By Fajar Alfarizi`,'seconds': '359996400', 'caption': global.fake, 'jpegThumbnail': global.thumb}}}
...
let menunyaa = `Menampilkan List Menu Felix-MD
...
const listMessage = {
  text: menunyaa,
  footer: "© Created By Fajar Alfarizi",
...
var extended = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"extendedTextMessage": {
"text": "https://wa.me/6281333782061",
"matchedText": "https://wa.me/6281333782061",
...
axios.get(`https://api.lolhuman.xyz/api/freefire/${idff}?apikey=Imanmpa`)
            .then(({data}) => {
m.reply('Tunggu Sebentar Kak, Felix-MD Akan Cek Id Kakak')
            })
            .catch((err) => {
...
case 'confirmorderkunci': { //KUNCI = BIAR GA DIAKSES HEHE
				...
				if (feta.status == false) {
  				...
  				liaacans.sendMessage(m.chat, {
    				caption: cap, image: {
      				url: feta.data.qris
    				}, buttons: buto, footer: `©Created Felix-MD`
  				})
				}
				console.log(feta)
				}
...
case 'proses':
            ...
            m.quoted.copyNForward(`6281333782061@s.whatsapp.net`, true)
            liaacans.sendMessage(`6281333782061@s.whatsapp.net`, {text: proses })
            break
        case 'done':
            if (!isCreator) return
...
case 'eja': case 'felix': case 'pelix': case 'fajar':{
